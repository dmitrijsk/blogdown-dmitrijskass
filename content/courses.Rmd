...
The content covers all steps of a typical data analysis project. Modelling is only briefly discussed with several examples of statistical tests and machine learning algorithms. The main emphasis is made on how to perform data pre-processing and post-processing to fits modelling into tall other steps covered:
...
<details><summary>Brief look at statistics and machine learning</summary>
<p>
* Data pre- and post-processing.
* Examples of statistical tests and machine learning algorithms.
</p>
</details>
