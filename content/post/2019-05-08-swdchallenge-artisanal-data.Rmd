...
tokens_freq_groups %>% 
  ...
  labs(title = "60-80% of words in the interviews are stop words and may be removed.",
       subtitle = "Using stop words from the SMART information retrieval system.",
       x = NULL, 
       y = "word count", 
       fill = NULL) +
  theme_minimal() +
...
p + 
  labs(title = "Ten important words of each interview",
       subtitle = "Word importance is measured by tf-idf.\nImportant words reveal how each interview is different from a lexical poit of view.\nWords highlighted in dark blue are discussed below this plot.",
       x = NULL, 
       y = NULL) +
...
Interestingly, 10 most important words within each interview do not necessarily highlight the theme of the interview. It may be a specific style of a speech as well. Shirley Wu uses a phrase <font color="#4f81bd">*"kind of"*</font> 29 times, as in, *"It was kind of through my involvement with ..."*. This phrase ends up being Shirley's 5th most important word, according to tf-idf, out of `r shirley_wu_unique_words` unique words she used.
