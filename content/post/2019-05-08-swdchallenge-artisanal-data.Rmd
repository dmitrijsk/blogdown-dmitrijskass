...
If you are not familiar with terms tf (term frequency) and idf (inverse document frequency) then they are described [below](#about-tf-idf) with examples. Otherwise, here is the illustration:
...
It means that the word is not important in describing the interview. Other words that have zero importance here are *`r setdiff(zero_tfidf, "learn")`*.
...
Here is the data used for plotting:
