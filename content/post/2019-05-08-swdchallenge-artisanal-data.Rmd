...
It does not matter how high $tf(learn)$ is, if $idf(learn)=0$, the $tfidf(learn)$ will also be zero. On the contrary, if a word is mentioned only in one interview from 12 then its tf gets multiplied by `r round(log(12/1), 2)`. This is what happened to the word "copy". Its importance rank by tf and tf-idf is #40 and #3, respectively.
