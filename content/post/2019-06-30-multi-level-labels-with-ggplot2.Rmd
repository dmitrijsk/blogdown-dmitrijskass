...
A simple approach is to modify x axis labels with a text formatting function that does three things:
...
3. Pastes the year behind the first letter of the month using a new line `\n` as a separator, if 
    * it is the first element in vector, or
    * the previous element in a vector has a different year component.
