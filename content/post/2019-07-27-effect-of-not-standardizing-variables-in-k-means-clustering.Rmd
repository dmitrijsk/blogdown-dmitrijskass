...
We used a small data set of iPhones to illustrate the effect of (not) standardizing variables in k-means clustering. Below is the side-by-side k-means clustering results for $k=2$ with original variables (left) and standardized variables (right):
