...
Throughout this post I use bold font for vectors (e.g., $\mathbf{w}$, $\mathbf{x}$) and regular font for scalars and functions (e.g., $w_0$, $J$).
...
<center>
![](images/learning_rate_1.gif){width=80%}
</center>
