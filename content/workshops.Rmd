...
With practice, the content of the [**Data analysis and visualization with R**](#r_name) workshop has proven to lay a solid foundation for applying R at work and continuing learning R independently. 

If you have an interest in other topics, the content may be tailored to your needs - please send me a description of topics you would like to cover to dmitrijs.kass@gmail.com.
...
This is a 3-day in-person workshop, where it is my pleasure to guide you from the basics to advanced data analysis and visualization with R. It suits both new R users and those, whose experience in R is fragmented. The content is built around essential skills that a working data analyst/scientist should be comfortable with. It was **battle-tested on 150+ participants** and [**earned honourable reviews**](#r_references). Participants of previous workshops emphasize my passion for clearly explaining new material, sharing practical experience and answering all your questions.

### Practical information

* 3-day in-person workshop guided by a working data scientist with 3+ years of teaching experience in both academia and industry.
* **Content**: full cycle of steps of a [typical data analysis project](#r_content).
* **Price**: 400 EUR per person; discounts apply to students and groups of 3+ members.
* **Place**: if the group consists of representatives of one company then your company's premises in Riga (Latvia) or other location; otherwise [the House of Science in University of Latvia Academic Centre](https://www.akademiskaiscentrs.lu.lv/ekas/zinatnu-maja/) or another place if the workshop is held outside Riga. 
...
The content covers in detail all steps of a typical data analysis project except for modelling, which is only briefly discussed to show how statistical tests and regression fit into the steps covered:

```{r, echo = FALSE, fig.cap = "Typical steps in a data science project as in \"R for Data Science\" by G. Grolemund and H. Wickham"}
...
“This course is valuable both for those who would like to learn about opportunities that R offers and for those who have learnt R on their own. Course material is very well structured with a focus on practical applications. After the course you will be able to put new knowledge straight into the practice.”  
Anonymous.
